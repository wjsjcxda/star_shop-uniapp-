...
<style lang="less">
	...
	@font-face {font-family: "iconfont";
	  src: url('https://gitee.com/ChenXin_QMX/wx_icon/iconfont.eot?t=1576844226174'); /* IE9 */
	  src: url('https://gitee.com/ChenXin_QMX/wx_icon/iconfont.eot?t=1576844226174#iefix') format('embedded-opentype'), /* IE6-IE8 */
	  ...
	  url('https://gitee.com/ChenXin_QMX/wx_icon/iconfont.woff?t=1576844226174') format('woff'),
	  url('https://gitee.com/ChenXin_QMX/wx_icon/iconfont.ttf?t=1576844226174') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+ */
	  url('https://gitee.com/ChenXin_QMX/wx_icon/iconfont.svg?t=1576844226174#iconfont') format('svg'); /* iOS 4.1- */
	}
